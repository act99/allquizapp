...
class IntelPlayQuiz extends StatefulWidget {
  List<QNA> qnas;
  final String id;
  final String poster;
  final String title;
  ...
  @override
  _IntelPlayQuiz createState() => _IntelPlayQuiz();
}

class _IntelPlayQuiz extends State<IntelPlayQuiz> {
  ...
  Widget _buildBody(BuildContext context, List<DocumentSnapshot> snapshot) {
    ...
    return IntelQuizList(qnas: qnas, poster: poster);
  }
...
class IntelQuizList extends StatefulWidget {
  final List<QNA> qnas;
  final String poster;
  IntelQuizList({this.qnas, this.poster});

  @override
  _IntelQuizList createState() => _IntelQuizList();
}

class _IntelQuizList extends State<IntelQuizList> {
  List<QNA> qnas;
  List<String> body;
