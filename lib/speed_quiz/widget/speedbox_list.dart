...
class SpeedBoxList extends StatefulWidget {
  @override
  _SpeedBoxList createState() => _SpeedBoxList();
}

class _SpeedBoxList extends State<SpeedBoxList> {
  Stream quizStream;
...
class SpeedQuizTile extends StatelessWidget {
  final String title;
  final String poster;
  final String id;
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SpeedPlayMainScreen(
                  id: id,
                  poster: poster,
                  title: title,
                ),
